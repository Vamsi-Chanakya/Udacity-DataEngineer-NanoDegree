...
"""
This step inserts the data into dimension and fact tables. 

Extraction Process:
Step 1: ETL process is comprised of creating 2 dimension tables which are songs table and artists table from song data (metadata) json file. 
